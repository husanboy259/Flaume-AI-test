# Graph Report - Flaume Fron  (2026-07-09)

## Corpus Check
- 145 files · ~106,465 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2071 nodes · 2412 edges · 149 communities (109 shown, 40 thin omitted)
...
- `DashboardLayout()` --indirect_call--> `User`  [INFERRED]
  src/components/layout/DashboardLayout.tsx → src/stores/authStore.ts
...
Cohesion: 0.05
Nodes (56): App(), queryClient, DashboardLayout(), Button, ButtonProps, buttonVariants, Card, CardContent (+48 more)
...
Cohesion: 0.06
Nodes (36): dependencies, axios, class-variance-authority, clsx, date-fns, framer-motion, @google/genai, @hookform/resolvers (+28 more)
...
### Community 70 - "shadcn/ui Accessibility Patterns"
Cohesion: 0.07
...
### Community 71 - "What You Must Do When Invoked"
Cohesion: 0.07
...
### Community 73 - "Logo AI Prompt Engineering"
Cohesion: 0.08
Nodes (25): Common Pitfalls, Core Prompt Structure, Detailed Brief, Eco/Sustainable, Effective Keywords by Style, Fashion Brand, Healthcare, Industry-Specific Prompts (+17 more)

### Community 74 - "Color Palette Management"
Cohesion: 0.08
...
### Community 75 - "CIP Deliverable Guide"
Cohesion: 0.08
...
### Community 76 - "States and Variants"
Cohesion: 0.08
...
### Community 77 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 78 - "UI Styling Skill"
Cohesion: 0.08
...
### Community 81 - "Tailwind CSS Customization"
Cohesion: 0.09
...
### Community 83 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
...
### Community 84 - "Asset Organization Guide"
Cohesion: 0.11
...
### Community 85 - "Primary Color Meanings"
Cohesion: 0.11
...
### Community 89 - "Design Principles"
Cohesion: 0.12
...
### Community 90 - "Design Principles"
Cohesion: 0.12
Nodes (15): 22 Art Direction Styles, Banner Sizes & Art Direction Styles Reference, Complete Banner Sizes, CTA Rules, Design Principles, Pinterest Research Queries, Print, Print Specs (+7 more)
...
### Community 95 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
...
### Community 96 - "Messaging Framework"
Cohesion: 0.14
...
### Community 97 - "Brand Voice Framework"
Cohesion: 0.14
...
### Community 99 - "Tailwind Integration"
Cohesion: 0.14
...
### Community 102 - "Logo Design Reference"
Cohesion: 0.15
...
### Community 107 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)
...
### Community 110 - "format_ascii_box"
Cohesion: 0.25
...
### Community 111 - "FLAUME AI Frontend"
Cohesion: 0.25
Nodes (7): ✨ Features Implemented, FLAUME AI Frontend, 📁 Folder Structure, 🔗 Future Backend Integration Notes, ⚠️ Important Security Warning, 🛠️ Installation & Setup, 🚀 Tech Stack
...
### Community 115 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 116 - "Slides"
Cohesion: 0.33
...
### Community 118 - "Brand Guidelines Template"
Cohesion: 0.40
...
## Knowledge Gaps
- **1037 isolated node(s):** `$schema`, `$value`, `$type`, `$value`, `$type` (+1032 more)
...
- **Why does `primitive` connect `Community 33` to `Community 1`, `Community 3`, `Community 7`, `Community 19`, `Community 25`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `color` connect `Community 1` to `Community 33`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `component` connect `Community 4` to `Community 3`?**
